    ...
    <div class="createrecce-content">
        <form action="create-script.php" method="post" enctype="multipart/form-data">
            ...
            <div class="create-section-2 form-group">
                <h1>Where is the location, located?</h1>
                <div class="control-group">
                    <label class="control-label">Address Line 1</label>
                    <div class="controls">
                        <input class="form-control" id="address-line1" name="address-line1" type="text" placeholder="address line 1"
                        class="input-xlarge">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="form-control" id="address-line2" name="address-line2" type="text" placeholder="address line 2"
                        class="input-xlarge">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="form-control" id="postal-code" name="postal-code" type="text" placeholder="zip or postal code"
                        class="input-xlarge">
                        <p class="help-block"></p>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="form-control" id="country" name="country" class="input-xlarge">
            ...
            <div class="create-section-4 form-group">
                <h1>What makes your location special?</h1>
                <h3>Location Features:</h3>
                <input type="checkbox" name="features[]" value="Wifi">Wifi<br>
                <input type="checkbox" name="features[]" value="Toilets">Toilets<br>
                <!-- when check pop up asking how many -->
                <input type="checkbox" name="features[]" value="Disabled">Disabled Access<br>
                <input type="checkbox" name="features[]" value="Parking">Parking<br>
                <!-- when check pop up asking how many -->
                <!-- when check pop up asking where the parking is (on road/off road) -->
                <input type="checkbox" name="features[]" value="Wifi">Lighting<br>

                <h3>Extras:</h3>
                <input type="checkbox" name="extras[]" value="Travel">Travel<br>
                <input type="checkbox" name="extras[]" value="Sound-Issues">Sound issues (nearby roads, airports etc.)<br>
                <input type="checkbox" name="extras[]" value="First-aid">First Aid availability<br>
                <input type="checkbox" name="extras[]" value="Floor-plans">Floor plans (future development)<br>
                <input type="checkbox" name="extras[]" value="Catering">Catering services (Can you offer sandwiches and ice cold lemonade?)/Local food services (shops, fast food)<br>
                <input type="checkbox" name="extras[]" value="Power">Power outlets<br>
                <!-- when check pop up asking how many -->

                <h3>Type of Location</h3>
                <select class="form-control" name="type" class="input-xlarge">
